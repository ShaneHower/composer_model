...
class Song:
    def __init__(self, wav):
        """
            This class stores all meta data about the song.  It also converts the sound wave into
            a numpy array.  The numpy array is what will ultimately be used to "write" a new song.
            This will be fed into the model during training and will be generated by the model there
            after.
